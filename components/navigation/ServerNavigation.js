    ...
    <div className="navigation">
      ...
      <div className="categories">
        ...
        <ServerCategory name="╔▬▬ Projets ▬▬╗" >
          <ServerChannel channelName="🔥》erosya" link="erosya" navigation={navigation} setNavigation={setNavigation} />
        ...
        <ServerCategory name="╔▬▬ No-Context ▬▬╗" >
          <ServerChannel channelName="🤸》truc-en-vrac" link="bulkInformation" navigation={navigation} setNavigation={setNavigation} />
          <ServerChannel channelName="🥚》easter-eggs" link="easterEggs" navigation={navigation} setNavigation={setNavigation} />
        </ServerCategory>
      </div>
    </div>
  )
